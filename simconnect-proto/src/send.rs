...
mod tests {
    ...
    fn request_system_state_matches_ground_truth() {
        let packet = request_system_state(6, 1, "AircraftLoaded")
            .unwrap()
            .finish(2);
    ...
    fn camera_set_relative_6dof_matches_ground_truth() {
        ...
        assert_eq!(
            packet,
            vec![
                0x28, 0x00, 0x00, 0x00, 0x06, 0x00, 0x00, 0x00, 0x30, 0x00, 0x00, 0xf0, 0x02, 0x00,
                0x00, 0x00, 0x00, 0x00, 0x80, 0x3f, 0x00, 0x00, 0x00, 0x40, 0x00, 0x00, 0x40, 0x40,
    ...
    fn subscribe_to_comm_bus_event_matches_ground_truth() {
        let packet = subscribe_to_comm_bus_event(6, 1, "MyEvent")
            .unwrap()
            .finish(2);
        assert_eq!(
            header_id(&packet),
    ...
    fn request_all_facilities_matches_ground_truth() {
        ...
        assert_eq!(
            header_id(&packet),
            opcode::kittyhawk::REQUEST_ALL_FACILITIES
        );
        assert_eq!(packet.len(), 24);
    }
    ...
    fn transmit_client_event_ex1_matches_ground_truth() {
        ...
        assert_eq!(
            packet,
            vec![
                0x34, 0x00, 0x00, 0x00, 0x06, 0x00, 0x00, 0x00, 0x44, 0x00, 0x00, 0xf0, 0x02, 0x00,
                0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00,
                0x00, 0x00, 0x00, 0x00, 0x0a, 0x00, 0x00, 0x00, 0x14, 0x00, 0x00, 0x00, 0x1e, 0x00,
                0x00, 0x00, 0x28, 0x00, 0x00, 0x00, 0x32, 0x00, 0x00, 0x00,
            ]
        );
    }
    ...
    fn enumerate_sim_objects_and_liveries_matches_ground_truth() {
        ...
        assert_eq!(
            packet,
            vec![
                0x18, 0x00, 0x00, 0x00, 0x06, 0x00, 0x00, 0x00, 0x5b, 0x00, 0x00, 0xf0, 0x02, 0x00,
    ...
    fn request_jetway_data_matches_ground_truth() {
        ...
        assert_eq!(
            packet,
            vec![
                0x28, 0x00, 0x00, 0x00, 0x06, 0x00, 0x00, 0x00, 0x4b, 0x00, 0x00, 0xf0, 0x02, 0x00,
                0x00, 0x00, 0x4b, 0x53, 0x45, 0x41, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    ...
    fn request_facilities_list_matches_ground_truth() {
        ...
        assert_eq!(
            packet,
            vec![
                0x18, 0x00, 0x00, 0x00, 0x06, 0x00, 0x00, 0x00, 0x43, 0x00, 0x00, 0xf0, 0x02, 0x00,
